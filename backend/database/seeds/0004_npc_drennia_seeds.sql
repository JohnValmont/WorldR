...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM companies WHERE name = 'Valuecorp' AND country_id = 'drennia') THEN
        ...
        INSERT INTO manufacturing_factories (company_id, world_instance_id, country_id, state_id, factory_type_id, name, lease_cost_per_arc, maintenance_cost_per_arc, capacity_per_arc, status, created_at_world_year, created_at_world_month, created_at_world_day)
