...
BEGIN
    ...
    IF v_sys_char_id IS NULL THEN
        INSERT INTO characters (user_id, world_instance_id, motherland_country_id, name, age, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
    ...
    IF NOT EXISTS (SELECT 1 FROM companies WHERE is_npc = TRUE AND npc_personality = 'valuecorp' AND country_id = 'drennia') THEN
        INSERT INTO companies (owner_character_id, world_instance_id, country_id, headquarters_state_id, industry_id, legal_structure_id, currency_id, name, status, is_npc, npc_personality, reputation, reliability, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
        VALUES (v_sys_char_id, 'pre-alpha-world-1', 'drennia', 'drennia-drennport', 'manufacturing', 'sole-trader', 'drennian-mark', 'Valuecorp', 'active', TRUE, 'valuecorp', 50, 50, 0, 0, 0)
        RETURNING id INTO v_company_id;

        INSERT INTO company_finances (company_id, currency_id, available_cash, debt, company_value, last_arc_profit)
        VALUES (v_company_id, 'drennian-mark', 1500000, 0, 1500000, 0);

        INSERT INTO manufacturing_vehicle_models (company_id, world_instance_id, name, vehicle_class, platform_type, power_unit_type, drivetrain_type, interior_tier, safety_tier, target_segment, sale_price, manufacturing_cost_per_unit, reliability_score, performance_score, fuel_efficiency_score, appeal_score, cargo_score, development_status, dev_stage, status, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
        ...
        INSERT INTO manufacturing_factories (company_id, world_instance_id, country_id, state_id, factory_type_id, name, lease_cost_per_arc, maintenance_cost_per_arc, capacity_per_arc, status, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
        ...
        INSERT INTO manufacturing_production_lines (company_id, world_instance_id, factory_id, line_number, assigned_vehicle_model_id, target_units_per_arc, status)
    ...
    IF NOT EXISTS (SELECT 1 FROM companies WHERE is_npc = TRUE AND npc_personality = 'veridian' AND country_id = 'drennia') THEN
        INSERT INTO companies (owner_character_id, world_instance_id, country_id, headquarters_state_id, industry_id, legal_structure_id, currency_id, name, status, is_npc, npc_personality, reputation, reliability, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
        VALUES (v_sys_char_id, 'pre-alpha-world-1', 'drennia', 'drennia-drennport', 'manufacturing', 'sole-trader', 'drennian-mark', 'Veridian Motors', 'active', TRUE, 'veridian', 50, 50, 0, 0, 0)
        RETURNING id INTO v_company_id;

        INSERT INTO company_finances (company_id, currency_id, available_cash, debt, company_value, last_arc_profit)
        VALUES (v_company_id, 'drennian-mark', 2500000, 0, 2500000, 0);
    ...
    IF NOT EXISTS (SELECT 1 FROM companies WHERE is_npc = TRUE AND npc_personality = 'apex' AND country_id = 'drennia') THEN
        INSERT INTO companies (owner_character_id, world_instance_id, country_id, headquarters_state_id, industry_id, legal_structure_id, currency_id, name, status, is_npc, npc_personality, reputation, reliability, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
        VALUES (v_sys_char_id, 'pre-alpha-world-1', 'drennia', 'drennia-drennport', 'manufacturing', 'sole-trader', 'drennian-mark', 'Apex Automobili', 'active', TRUE, 'apex', 50, 50, 0, 0, 0)
        RETURNING id INTO v_company_id;

        INSERT INTO company_finances (company_id, currency_id, available_cash, debt, company_value, last_arc_profit)
        VALUES (v_company_id, 'drennian-mark', 2000000, 0, 2000000, 0);
    ...
    IF NOT EXISTS (SELECT 1 FROM companies WHERE is_npc = TRUE AND npc_personality = 'haulpro' AND country_id = 'drennia') THEN
        INSERT INTO companies (owner_character_id, world_instance_id, country_id, headquarters_state_id, industry_id, legal_structure_id, currency_id, name, status, is_npc, npc_personality, reputation, reliability, created_at_world_orbit, created_at_world_arc, created_at_world_mark)
        VALUES (v_sys_char_id, 'pre-alpha-world-1', 'drennia', 'drennia-drennport', 'manufacturing', 'sole-trader', 'drennian-mark', 'HaulPro', 'active', TRUE, 'haulpro', 50, 50, 0, 0, 0)
        RETURNING id INTO v_company_id;
