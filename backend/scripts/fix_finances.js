...
content = content.replace(/VALUES \(v_company_id, 1500000, 0, 1500000, 0\)/g, "VALUES (v_company_id, 'dollar', 1500000, 0, 1500000, 0)");
content = content.replace(/VALUES \(v_company_id, 2500000, 0, 2500000, 0\)/g, "VALUES (v_company_id, 'dollar', 2500000, 0, 2500000, 0)");
content = content.replace(/VALUES \(v_company_id, 2000000, 0, 2000000, 0\)/g, "VALUES (v_company_id, 'dollar', 2000000, 0, 2000000, 0)");
