...
part1 = part1.replace('salesManagerBonus: number', 'salesManagerBonusMap: Map<string, number>');
part1 = part1.replace(
...
`;
part1 = part1.replace('export class ManufacturingController {', 'export class ManufacturingController {\n' + addKnowledgeFn);
...
const blockEnd = part3.indexOf('salesManagerBonus', blockStart) + 26; // Covers up to '      );'
