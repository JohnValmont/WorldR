...
export const manufacturingApi = {
  ...
  updateFactoryMaintenance: (companyId: string, factoryId: string, modifier: number) => api.patch(`/companies/${companyId}/manufacturing/factories/${factoryId}/maintenance`, { maintenance_budget_modifier: modifier }),
