    ...
    >
      ...
      <div className="px-4 py-3">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between px-3 py-2 rounded-sm" style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.22)' }}>
...
export default function WorldEntryPage() {
  ...
  return (
    <div
      ...
      style={{ opacity: revealed ? 1 : 0, transform: revealed ? 'translateY(0)' : 'translateY(14px)', backgroundColor: '#07100D' }}
    >
        ...
        {activeContinent === 'varelia' ? (
          <div>
            <div className="flex items-center gap-2 mb-5">
              <span className="text-[9px] font-mono uppercase tracking-[0.25em] px-2 py-1 rounded-sm" style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.25)', color: '#818cf8' }}>Varelia</span>
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <div className="rounded-sm flex flex-col items-center justify-center px-6 py-10 text-center" style={{ width: '200px', background: 'rgba(255,255,255,0.01)', border: '1px dashed rgba(255,255,255,0.06)' }}>
                <div className="w-8 h-8 rounded-sm flex items-center justify-center mb-3" style={{ background: 'rgba(99,102,241,0.07)', border: '1px solid rgba(99,102,241,0.15)' }}>
                  <svg className="w-4 h-4 opacity-40" viewBox="0 0 24 24" fill="none" stroke="#6366f1" strokeWidth={1.5}><path strokeLinecap="round" d="M12 4v16m8-8H4" /></svg>
                </div>
