...
export type PoliticsSection =
  | 'overview' | 'party' | 'campaign' | 'elections' | 'legislature' | 'nation' | 'policy' | 'assembly' | 'lobby';
...
function Icon({ name }: { name: PoliticsSection }) {
  ...
  switch (name) {
    ...
    case 'nation':      return (<svg {...c}><circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3a15 15 0 0 1 0 18a15 15 0 0 1 0-18z"/></svg>);
