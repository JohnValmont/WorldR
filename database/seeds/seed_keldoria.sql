...
-- ============================================================================
-- 7. POLITICAL PARTIES (8 Keldoria starter parties)
-- ============================================================================

-- KSD - Keldorian Social Democrats
INSERT INTO parties (id, nation_id, name, abbreviation, ideology, description, slogan, manifesto, economic_stance, social_stance, hq_region, color, member_count, support_share, seats, is_governing, is_ai_controlled, funds, founded_year, founded_tick)
VALUES (
  'a1000000-0000-4000-a000-000000000001',
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'Keldorian Social Democrats', 'KSD', 'social_democrat',
  'The oldest democratic party in Keldoria. Founded by industrial workers, now representing a broad coalition of workers, public employees, and progressive middle class.',
  'Gemeinsam Vorwaerts - Together Forward',
  'We believe in an economy that works for everyone. Strong public services, fair wages, and a welfare state that leaves no one behind. We govern for the working majority, not the privileged few.',
  'centre_left', 'liberal',
  'Rheinlund',
  '#e63946',
  4200, 0.2400, 108, TRUE, FALSE, 2800000.00, 580, 0
) ON CONFLICT (id) DO NOTHING;

-- CCU - Christian Conservative Union
INSERT INTO parties (id, nation_id, name, abbreviation, ideology, description, slogan, manifesto, economic_stance, social_stance, hq_region, color, member_count, support_share, seats, is_governing, is_ai_controlled, funds, founded_year, founded_tick)
VALUES (
  'a1000000-0000-4000-a000-000000000002',
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'Christian Conservative Union', 'CCU', 'conservative',
  'The party of tradition, fiscal responsibility, and national identity. Rooted in Christian democratic values, the CCU champions a strong economy with family at its center.',
  'Ordnung und Wohlstand - Order and Prosperity',
  'A strong economy requires sound finances, not reckless spending. We protect what works - our institutions, our families, our fiscal discipline - while opening doors for enterprise and innovation.',
  'centre_right', 'traditional',
  'Suedmark',
  '#457b9d',
  3800, 0.2200, 99, FALSE, FALSE, 3200000.00, 612, 0
) ON CONFLICT (id) DO NOTHING;

-- KGP - Keldorian Greens
INSERT INTO parties (id, nation_id, name, abbreviation, ideology, description, slogan, manifesto, economic_stance, social_stance, hq_region, color, member_count, support_share, seats, is_governing, is_ai_controlled, funds, founded_year, founded_tick)
VALUES (
  'a1000000-0000-4000-a000-000000000003',
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'Keldorian Greens', 'KGP', 'green',
  'Born from the environmental movement, the Greens now champion a full green transition: clean energy, sustainable cities, and a just economy that respects planetary limits.',
  'Zukunft Jetzt - Future Now',
  'Climate is not a future problem - it is the defining challenge of our generation. We will transform Keldoria into a carbon-neutral powerhouse, creating green jobs and protecting our communities from climate chaos.',
  'centre_left', 'progressive',
  'Veldenmoor Metro',
  '#2d6a4f',
  2100, 0.1400, 63, TRUE, FALSE, 1200000.00, 798, 0
) ON CONFLICT (id) DO NOTHING;

-- FLD - Free Liberal Democrats
INSERT INTO parties (id, nation_id, name, abbreviation, ideology, description, slogan, manifesto, economic_stance, social_stance, hq_region, color, member_count, support_share, seats, is_governing, is_ai_controlled, funds, founded_year, founded_tick)
VALUES (
  'a1000000-0000-4000-a000-000000000004',
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'Free Liberal Democrats', 'FLD', 'libertarian',
  'Champions of individual liberty, economic freedom, and minimal government interference. The FLD believes Keldorians build better lives when the state gets out of the way.',
  'Freiheit Zuerst - Freedom First',
  'Lower taxes, less regulation, maximum personal freedom. We trust Keldorians to make their own choices. Our mission is to remove the barriers that hold back entrepreneurs, innovators, and individuals from reaching their full potential.',
  'right', 'liberal',
  'Westmark',
  '#f4a261',
  1400, 0.1100, 49, FALSE, FALSE, 1800000.00, 680, 0
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'United Left Alliance', 'ULA', 'socialist',
  'The radical left alternative. ULA was formed from a merger of workers unions, socialist movements, and anti-austerity campaigners demanding structural economic transformation.',
  'Das Volk zuerst - The People First',
  'We are done with half-measures. The era of corporate dominance must end. We demand public ownership of energy and housing, a 30-hour work week, and taxes on wealth that actually fund the society we all deserve.',
  'left', 'progressive',
  'Ostmark',
  '#9d0208',
  1100, 0.0900, 41, FALSE, FALSE, 650000.00, 742, 0
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  ...
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'National Reform Party', 'NRP', 'nationalist',
  'The NRP emerged from rural dissatisfaction and anti-immigration sentiment. They combine economic protectionism with strong cultural conservatism and skepticism of Alderis institutions.',
  'Keldoria den Keldoriern - Keldoria for Keldorians',
  'Globalism has failed working Keldorians. Our jobs went abroad. Our culture is under threat. Our borders are open. We will restore Keldorian sovereignty, protect our industries from unfair competition, and put our people first.',
  'centre', 'conservative',
  'Ostmark',
  '#1d3557',
  980, 0.0800, 36, FALSE, TRUE, 1100000.00, 821, 0
) ON CONFLICT (id) DO NOTHING;

-- TPP - Technocratic Progress Party
INSERT INTO parties (id, nation_id, name, abbreviation, ideology, description, slogan, manifesto, economic_stance, social_stance, hq_region, color, member_count, support_share, seats, is_governing, is_ai_controlled, funds, founded_year, founded_tick)
VALUES (
  'a1000000-0000-4000-a000-000000000007',
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'Technocratic Progress Party', 'TPP', 'technocratic',
  'The TPP believes good governance is about evidence, expertise, and efficiency - not ideology. Founded by economists, engineers, and scientists frustrated by political dysfunction.',
  'Daten statt Demagogie - Data not Demagogy',
  'Politics fails when ideology trumps evidence. We will build a government that actually works: evidence-based policy, independent expert agencies, outcome-measured spending, and zero tolerance for corruption.',
  'centre_right', 'centre',
  'Veldenmoor Metro',
  '#6a4c93',
  720, 0.0700, 32, FALSE, TRUE, 900000.00, 845, 0
) ON CONFLICT (id) DO NOTHING;

-- ARU - Agrarian & Rural Union
INSERT INTO parties (id, nation_id, name, abbreviation, ideology, description, slogan, manifesto, economic_stance, social_stance, hq_region, color, member_count, support_share, seats, is_governing, is_ai_controlled, funds, founded_year, founded_tick)
VALUES (
  'a1000000-0000-4000-a000-000000000008',
  'b1a2c3d4-e5f6-7890-abcd-ef1234567890',
  'Agrarian & Rural Union', 'ARU', 'centrist',
  'The ARU is the voice of rural Keldoria - farmers, village communities, and regional tradespeople who feel forgotten by city-based parties.',
  'Land und Leben - Land and Life',
  'The countryside feeds and sustains our nation, yet rural Keldoria has been left behind. We fight for agricultural subsidies, rural infrastructure, regional healthcare, and a tax system that does not punish those who work the land.',
  'centre', 'traditional',
  'Suedmark',
  '#606c38',
  520, 0.0500, 22, FALSE, TRUE, 480000.00, 650, 0
) ON CONFLICT (id) DO NOTHING;
...
-- ============================================================================
-- 9. VOTER BLOC PARTY AFFINITIES
-- ============================================================================
-- KSD affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000001', 'a1000000-0000-4000-a000-000000000001', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000002', 'a1000000-0000-4000-a000-000000000001', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.350, 0.350),
  ('bb000001-0000-4000-a000-000000000003', 'a1000000-0000-4000-a000-000000000001', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.200, 0.200),
  ('bb000001-0000-4000-a000-000000000011', 'a1000000-0000-4000-a000-000000000001', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000012', 'a1000000-0000-4000-a000-000000000001', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.250, 0.250),
  ('bb000001-0000-4000-a000-000000000006', 'a1000000-0000-4000-a000-000000000001', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.250, 0.250)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- CCU affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000006', 'a1000000-0000-4000-a000-000000000002', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000007', 'a1000000-0000-4000-a000-000000000002', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.350, 0.350),
  ('bb000001-0000-4000-a000-000000000009', 'a1000000-0000-4000-a000-000000000002', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000010', 'a1000000-0000-4000-a000-000000000002', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.350, 0.350),
  ('bb000001-0000-4000-a000-000000000003', 'a1000000-0000-4000-a000-000000000002', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.250, 0.250)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- KGP affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000004', 'a1000000-0000-4000-a000-000000000003', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000005', 'a1000000-0000-4000-a000-000000000003', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.350, 0.350),
  ('bb000001-0000-4000-a000-000000000003', 'a1000000-0000-4000-a000-000000000003', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.150, 0.150)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- FLD affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000008', 'a1000000-0000-4000-a000-000000000004', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.450, 0.450),
  ('bb000001-0000-4000-a000-000000000010', 'a1000000-0000-4000-a000-000000000004', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000009', 'a1000000-0000-4000-a000-000000000004', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.350, 0.350),
  ('bb000001-0000-4000-a000-000000000004', 'a1000000-0000-4000-a000-000000000004', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.250, 0.250)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- ULA affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000002', 'a1000000-0000-4000-a000-000000000005', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.350, 0.350),
  ('bb000001-0000-4000-a000-000000000012', 'a1000000-0000-4000-a000-000000000005', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.400, 0.400),
  ('bb000001-0000-4000-a000-000000000005', 'a1000000-0000-4000-a000-000000000005', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.300, 0.300)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- NRP affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000007', 'a1000000-0000-4000-a000-000000000006', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.300, 0.300),
  ('bb000001-0000-4000-a000-000000000012', 'a1000000-0000-4000-a000-000000000006', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.200, 0.200),
  ('bb000001-0000-4000-a000-000000000001', 'a1000000-0000-4000-a000-000000000006', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.150, 0.150)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- TPP affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000009', 'a1000000-0000-4000-a000-000000000007', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.200, 0.200),
  ('bb000001-0000-4000-a000-000000000004', 'a1000000-0000-4000-a000-000000000007', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.200, 0.200),
  ('bb000001-0000-4000-a000-000000000008', 'a1000000-0000-4000-a000-000000000007', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.150, 0.150)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;

-- ARU affinities
INSERT INTO voter_bloc_party_affinity (voter_bloc_id, party_id, nation_id, base_affinity, current_affinity) VALUES
  ('bb000001-0000-4000-a000-000000000007', 'a1000000-0000-4000-a000-000000000008', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.250, 0.250),
  ('bb000001-0000-4000-a000-000000000001', 'a1000000-0000-4000-a000-000000000008', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.100, 0.100),
  ('bb000001-0000-4000-a000-000000000006', 'a1000000-0000-4000-a000-000000000008', 'b1a2c3d4-e5f6-7890-abcd-ef1234567890', 0.100, 0.100)
ON CONFLICT (voter_bloc_id, party_id) DO NOTHING;
