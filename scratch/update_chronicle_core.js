...
// 4. Update the render block conditionals
page = page.replace(
...
// 5. Replace CompanyDeskTab but KEEP EVERYTHING ELSE!
const compStartStr = "// COMPANY DESK TAB";
const nextCompStartStr = "// CONTRACTS TAB";
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  const afterComp = page.substring(endIndex);
...
`;
  ...
  fs.writeFileSync('d:\\WorldR\\frontend\\src\\app\\drennia\\business\\page.tsx', beforeComp + newComponent + "\n" + afterComp);
}
