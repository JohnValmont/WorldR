...
extractComponent('FactoryTab', '{/* FACTORY TAB */}', '{/* R&D / DESIGN TAB */}', factoryHandlers);
extractComponent('ProcurementPanel', '{/* PROCUREMENT TAB */}', '{/* PRODUCTION TAB */}', procHandlers);
extractComponent('ManufacturingOverview', '{/* OVERVIEW TAB */}', '{/* FACTORY TAB */}', adminHandlers);

console.log("Restored tabs correctly");
